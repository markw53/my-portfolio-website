...
const SKILLS = {
	...
	programmingLanguages: [
		{name: 'Python', icon: '/photos/Python.svg'},
		{name: 'Java', icon: '/photos/Java.svg'}, 
		{name: 'SQL', icon: '/photos/sql-database-generic-svgrepo-com.svg'}, 
		{name: 'HTML', icon: '/photos/HTML5.svg'},
		{name: 'CSS', icon: '/photos/CSS3.svg'},
		{name: 'JavaScript', icon: '/photos/JavaScript.svg'},
	],
	technologies: [
		{name: 'Svelte', icon: '/photos/Svelte.svg'},
		{name: 'Sveltekit', icon: '/photos/Svelte.svg'},
		{name: 'React', icon: '/photos/React.svg'},
		{name: 'Node.js', icon: '/photos/Node.js.svg'},
		{name: 'PostgreSQL', icon: '/photos/PostgresSQL.svg'},
		{name: 'Git', icon: '/photos/Git.svg'},
		{name: 'GitHub', icon: '/photos/GitHub.svg'},
		{name: 'Jest', icon: '/photos/Jest.svg'},
		{name: 'Bootstrap', icon: '/photos/Bootstrap.svg'},
		{name: 'Material UI', icon: '/photos/Material-UI.svg'},
		{name: 'WordPress', icon: '/photos/WordPress.svg'},
		{name: 'Tailwind CSS', icon: '/photos/Tailwind-CSS.svg'},
		{name: 'Express', icon: '/photos/Express.png'},
	]
};
...
const PROJECTS = [
    ...
    //},	
	{
        ...
        type: 'Svelte Web App',
        description: '',
        photo: { src: '/photos/sveltekit-tw.jpg', alt: '' },
    ...
    },
    {
		...
		link: 'https://kw-nc-news.netlify.app/',
